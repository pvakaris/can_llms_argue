...
PROMPT_CONFIG_FILE = Path(os.getenv("ORACLE_PROMPT_CONFIG_FILE", "resources/oracle_config/config_aif_llama.txt"))
...
LLAMA_CONFIG = {
    "MODEL_NAME": os.getenv("ORACLE_LLAMA_MODEL_NAME", "meta-llama/Llama-3.2-1B-Instruct"),
    "MAX_TOKENS": int(os.getenv("ORACLE_LLAMA_MAX_TOKENS", 256)),
    "TEMPERATURE": float(os.getenv("ORACLE_LLAMA_TEMPERATURE", 0.3))
}
...
UVA_CONFIG = {
    "MODEL_NAME": os.getenv("ORACLE_UVA_MODEL_NAME", "gpt-4"),
